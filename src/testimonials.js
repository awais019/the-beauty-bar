document.addEventListener("DOMContentLoaded", () => {
  ...
  <li
            ...
            >
              <div class="relative flex flex-col gap-4 laptopSm:flex-row laptopSm:gap-12 max-laptopSm:h-48">
                ...
                <img
                  ...
                  alt="customer"
                  class="absolute -top-5 right-1/4 laptopSm:top-1/3 laptopSm:left-[38%]"
                />
              </div>
              <div
